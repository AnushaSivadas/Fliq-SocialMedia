...
const Post = ({data,index}) => {
  ...
  console.log("reportedData",data.reports)
    ...
    const handleButtonClick=()=>{
      Swal.fire({
        ...
        if (result.isConfirmed) {
         ...
         setStatus(!status)
        status?Swal.fire('Reported!', 'The post has been reported.', 'success'):Swal.fire('Activated!', 'The post has been activated.', 'success');
